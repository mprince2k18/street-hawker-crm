<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="https://streethawker.com.bd/frontEnd/img/logo/5.png" width="25" alt="Aero"><span class="m-l-10">Street Hawker</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="https://koms.korloy.com/resource/lib/ace-admin/assets/avatars/profile-pic.jpg" alt="User"></a>
                    <div class="detail">
